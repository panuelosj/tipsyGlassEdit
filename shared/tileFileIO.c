...
tipsy* readTipsyStd(const char filename[]){
    ...
    */
    ...
    newTipsy->header = (header*)malloc(sizeof(header));                                  // Allocate space
    ...
    if (newTipsy->header->nsph != 0){                                           // Check if particles exist
        newTipsy->gas = (gas_particle*)malloc(newTipsy->header->nsph*sizeof(gas_particle));    // Allocate space
    ...
    if (newTipsy->header->ndark != 0){                                          // Check if particles exist
        newTipsy->dark = (dark_particle*)malloc(newTipsy->header->nsph*sizeof(dark_particle));  // Allocate space
    ...
    if (newTipsy->header->nstar != 0){                                          // Check if particles exist
        newTipsy->star = (star_particle*)malloc(newTipsy->header->nsph*sizeof(star_particle));  // Allocate space
